...
function ToolbarNode(_a) {
    ...
    return (react_1.default.createElement("li", Object.assign({ id: wpAdminBar(id), className: (0, classnames_1.default)('menupop', { hover }, additionalClassNames), onMouseEnter: () => {
            setHover(true);
        }, onMouseLeave: () => {
            setHover(false);
        } }, props), children));
